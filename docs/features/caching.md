...
export const CACHE_KEYS = {
  ...
  topAnime: (page: number) => `top-anime-page-${page}`,
  seasonAnime: (year: number, season: string) => `season-${year}-${season}`,
  // ...
}
```

Keys consistentes evitan colisiones y facilitan invalidación.
