<template>
  ...
  <NuxtLink
    ...
    class="group relative block cursor-pointer overflow-hidden rounded-lg bg-rp-surface shadow-md border border-rp-overlay transition-all duration-300 hover:border-rp-iris/50 hover:shadow-rp-iris/20 focus-rp sm:rounded-xl sm:shadow-lg md:rounded-2xl md:shadow-2xl"
