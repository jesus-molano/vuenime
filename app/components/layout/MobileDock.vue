<template>
  <Transition name="dock-slide">
    <nav
      ...
      :style="{
        bottom: `calc(${footerHeight}px + max(1rem, env(safe-area-inset-bottom, 0px)))`,
      }"
    >
      <div
      ...
      >
        <NuxtLink
          to="/"
          class="nav-link-explore group relative flex items-center justify-center rounded-xl p-3 transition-all"
          :class="
            $route.path === '/'
